        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <AnimatedCard delay={0} className="relative">
            <Link href="/app-service" className="block">
              <div className="relative h-[496px] rounded-[24px] flex justify-center items-center overflow-hidden bg-linear-to-b from-[#eff5b3] to-[#3a4913]">
                {/* Left phone (behind) */}
          ...
          <AnimatedCard delay={150} className="relative">
            <Link href="/aerial-reports-service" className="block">
              <div className="relative h-[496px] rounded-[24px] overflow-hidden bg-linear-to-b from-[#26b285] to-[#012d1f]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                  <span className="text-white text-[32px] italic font-medium font-(family-name:--font-plus-jakarta) drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
                    {t("drone.title")}
                  </span>
                  <div className="w-[48px] h-[48px] flex items-center justify-center">
                    <ArrowUpRight className="w-8 h-8 text-white" />
          ...
          <AnimatedCard delay={300} className="relative">
            <Link href="/intelligent-irrigation" className="block">
              <div className="relative h-[496px] rounded-[24px] overflow-hidden bg-linear-to-b from-[#26b285] to-[#012d1f]">
                ...
                <div className="absolute inset-0 bg-[rgba(1,51,34,0.2)]" />
                <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                  <span className="text-white text-[32px] italic font-medium font-(family-name:--font-plus-jakarta) drop-shadow-[0_4px_8px_rgba(0,0,0,0.05)]">
                    {t("buggy.title")}
                  </span>
                  <div className="w-[48px] h-[48px] flex items-center justify-center">
                    <ArrowUpRight className="w-8 h-8 text-white" />
